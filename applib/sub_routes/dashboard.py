...
def get_year_range():
    ...
    rng = calendar.monthrange(dt.year, dt.month)

    start = datetime.datetime(dt.year, 1, 1,hour=0, minute=0, second=0)
    end = datetime.datetime(dt.year, dt.month, rng[1],hour=23, minute=59, second=59)
